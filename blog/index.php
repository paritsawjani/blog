      ...
      <div class="posts-wrapper">
        <div class="post">
          <div class="inner-post">
            <img src="assets/images/image_7.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 4px; border-top-right-radius: 4px;">
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Parit Sawjani
                  &nbsp;
                  <i class="fa fa-calendar"></i> Jan 4, 2020
                </div>
            </div>
          </div>
        </div>
        <div class="post">
          <div class="inner-post">
            <img src="assets/images/image_6.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 4px; border-top-right-radius: 4px;">
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Parit Sawjani
        ...
        <div class="post">
          <div class="inner-post">
            <img src="assets/images/image_5.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 4px; border-top-right-radius: 4px;">
            <div class="post-info">
              <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                <div>
                  <i class="fa fa-user-o"></i> Parit Sawjani
        ...
        <div class="post">
          <div class="inner-post">
            <img src="assets/images/image_4.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 4px; border-top-right-radius: 4px;">
            <div class="post-info">
